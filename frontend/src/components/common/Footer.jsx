          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <div className="flex flex-row items-center gap-2 ml-[-20px]">
                ...
                />
                <p className="text-richblack-50">PathShala</p>
              </div>
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link
                to="https://github.com/IntellectGovi"
                target="__blank"
            ...
            <span> © 2024 PathShala</span>
          </div>

          <div className="flex items-center">
            <a
              href="https://www.linkedin.com/in/govind-upadhyay/"
            ...
            <a
              href="https://www.github.com/IntellectGovi"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
